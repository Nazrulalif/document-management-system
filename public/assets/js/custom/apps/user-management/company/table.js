                        ...
                        return `
                            ...
                            <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="view" data-id="${data.id}">
                                        View
                                    </a>
                                </div>
                                <!--end::Menu item-->
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            error: function (xhr) {
                                // Handle the error
                                Swal.fire({
                                    text: "There was an error deleting " + customerName + ". Please try again.",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        error: function () {
                            Swal.fire({
                                text: "There was an error deleting selected customers. Please try again.",
                                icon: "error",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
