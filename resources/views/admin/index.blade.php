            ...
            <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-8">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="row gy-5 gx-xl-10">
                        ...
                        <div
                            class="col-sm-5 col-md-6 col-xl-5 mb-xl-10 {{ Auth::user()->role_guid == 1 ? 'col-xl-5' : 'col-xl-7' }}">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Amount-->
                                            <span
                                                class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{ number_format($totalCurrentStorage, 2) }}
                                                MB</span>
                                            <!--end::Amount-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="card card-flush h-lg-100">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $todayLogin }}</span>
                                            <div class="m-0">
