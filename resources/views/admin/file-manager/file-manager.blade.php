                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr data-folder-id="{{ $folder->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{ route('folder.show', $folder->uuid) }}"
                                ...
                                <tr data-document-id="{{ $document->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="icon-wrapper">
                                                <i class="ki-duotone ki-file fs-2x gray-800 me-4">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i>
                                            </span>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <a href="{{ $document->uuid }}" class="menu-link px-3">View</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link text-danger px-3"
...
{{-- <script src="{{ asset('assets/js/custom/apps/file-manager/list-2.js')}}"></script> --}}
