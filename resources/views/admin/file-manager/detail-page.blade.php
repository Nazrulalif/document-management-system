                                        ...
                                        @else
                                            <div class="d-flex flex-end">
                                                @if ($data->doc_type == 'pdf')
                                                    <a href="{{ url('/file/' . base64_encode($data->file_path)) }}"
                                                        target="_blank" class="btn btn-sm btn-secondary mt-5 me-3">
                                                        View
                                                    </a>
                                                @endif
                                                {{-- <a href=""
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="text-gray-600 fw-semibold fs-6">
                                                        @foreach ($doc_summary as $line)
                                                            <p>{{ $line }}</p>
                                                            <!-- Display each line inside a paragraph -->
                                                        @endforeach
                                                    </div>
                                                    <!--end::Label-->
                                                    <!--end::Item-->
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <div class="timeline-content fw-bold text-primary ps-3">
                                                                    ...
                                                                    @else
                                                                        <a type="button" data-bs-toggle="modal"
                                                                            ...
                                                                            data-delete="{{ url('/admin/old-version/destroy/' . $item->uuid) }}"
                                                                ...
                                                                <div class="fw-semibold text-gray-700 ps-3 fs-7">
                                                                    ...
                                                                    @if ($loop->first)
                                                                        ...
                                                                        <span
                                                                            class="badge badge-light-success">Latest</span>
                                                                    @endif
    ...
    <script>
        $(document).ready(function() {
            $('#kt_modal_view_version').on('show.bs.modal', function(event) {
                ...
                $(document).on('click', '[id="modaldelete"]', function(e) {
                    e.preventDefault();

                    var deleteUuid = button.data('delete');
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url: deleteUuid, // Assuming RESTful API convention
                                method: 'POST',
                                headers: {
