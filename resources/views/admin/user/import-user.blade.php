                ...
                <form id="kt_modal_export_users_form" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <label class="fs-6 fw-semibold form-label mb-2">Download registration template
                                here</label><br>
                            <a href="{{ route('download.template') }}" class="btn btn-secondary"
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <select class="form-select form-control form-select-solid mb-3 mb-lg-0"
                            data-selection="role_name" data-control="select2" name="role_name" id="role_name"
                            data-placeholder="Select a role" data-hide-search="true" required>
                            <option></option>
            ...
            myDropzone.on("error", function (file, response) {
                ...
                toastr.error(
                    ...
                    'Import Error', {
                        closeButton: true,
                        progressBar: true,
                        timeOut: 5000, // Duration for the toast to be visible
                        positionClass: 'toastr-top-right', // Position of the toast
                    }
                );
                Swal.fire({
