...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="kt_account_profile_details_form" action="{{ route('setting.post') }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            <!--begin::Card body-->
...
<div class="card mb-5 mb-xl-10" >
    ...
    <div id="kt_change_password" class="collapse show">
        <form action="{{ route('password.change') }}" method="POST" enctype="multipart/form-data" autocomplete="off" class="form">
            @csrf
            <div class="card-body border-top p-9">
                <div class="row mb-6">
                    <!--begin::Label-->
