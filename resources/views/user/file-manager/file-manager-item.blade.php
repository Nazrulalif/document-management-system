                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="badge badge-lg badge-light-primary">
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <a
                                        href="{{ route('folder.show.user', $folder->uuid) }}">{{ $folder->folder_name }}</a>
                            ...
                            <div class="badge badge-lg badge-primary">
                                <span id="kt_file_manager_items_counter">{{ $folder->children->count() + $documents->count() }} items</span>
                            </div>
                            <!--end::Folder Stats-->
                        </div>
                        <!--end::Table header-->
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6" id="kt_datatable_zero_configuration">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @if($folder->children->count() > 0 || $documents->count() > 0)
                                    ...
                                    <tr data-folder-id="{{ $childFolder->id }}">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="{{ route('folder.show.user', $childFolder->uuid) }}"
                                        ...
                                        <td class="text-center">
                                            @if(in_array($childFolder->id, $starredFolders))
                                            
                                            <i class="ki-duotone ki-star fs-3 star-icon text-warning cursor-pointer"
                                                data-id="{{ $childFolder->id }}" data-type="folder"></i> <!-- Starred -->
                                            @else
                                            <i class="ki-outline ki-star fs-3 star-icon cursor-pointer" data-id="{{ $childFolder->id }}"
