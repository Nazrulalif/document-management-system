...
<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" action="{{ Route('password.update') }}" method="POST">
    ...
    <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-gray-900 fw-bolder mb-3">Password Expired</h1>
        <!--end::Title-->
        <!--begin::Link-->
        <div class="text-gray-500 fw-semibold fs-6">Your password has expired. Please set a new password to continue. 
            <a href="{{ route('logout') }}" class="menu-link">Login</a>
        </div>
        <!--end::Link-->
    </div>
